                                ...
                                <div class="modal-content rounded-4 shadow">
                                    ...
                                    <div class="modal-body p-4">
                                        <div class="row g-4">
                                            <div class="col-md-6">
                                                <div class="bg-light p-3 border rounded">
                                                    <h6 class="text-primary fw-bold mb-3"><i class="bx bx-user"></i> Informasi Pribadi</h6>
                                                    <p><strong>Nama:</strong> {{ $data->nama }}</p>
                                                    <p><strong>Email:</strong> {{ $data->email }}</p>
                                                    <p><strong>Jenis Kelamin:</strong> {{ $data->jenis_kelamin }}</p>
                                                    <p><strong>Tempat Lahir:</strong> {{ $data->tempat_lahir ?: '-' }}</p>
                                                    <p><strong>Tanggal Lahir:</strong> {{ \Carbon\Carbon::parse($data->tanggal_lahir)->translatedFormat('d F Y') }}</p>
                                            ...
                                            <div class="col-md-6">
                                                <div class="bg-light p-3 border rounded">
                                                    <h6 class="text-primary fw-bold mb-3"><i class="bx bx-file"></i> Informasi Pendaftaran</h6>
                                        ...
                                        <div class="bg-white mt-4 p-3 border rounded">
                                            <h6 class="text-primary fw-bold"><i class="bx bx-note"></i> Keterangan</h6>
                                            <p>{{ $data->keterangan }}</p>
                                        </div>
                                        @endif
                                    </div>
                                    <div class="modal-footer border-0 px-4 py-3 bg-light">
                                        ...
                                        <a href="https://wa.me/62{{ ltrim($data->no_telepon, '0') }}?text=Halo%20Kami%20dari%20Tim%20Victory%2C%20Apakah%20Anda%20masih%20tertarik%20bergabung%3F" class="btn btn-success" target="_blank">
