                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                <input type="text"
                                    ...
                                    maxlength="30" pattern="[0-9]+" inputmode="numeric"/>
                            </div>
                            @error('no_rekening')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select name="bank" class="form-control @error('bank') is-invalid @enderror" id="bank">
                                ...
                                <option value="BCA" {{ old('bank') == 'BCA' ? 'selected' : '' }}>Bank Central Asia (BCA)</option>
                                <option value="BNI" {{ old('bank') == 'BNI' ? 'selected' : '' }}>Bank Negara Indonesia (BNI)</option>
                                <option value="BRI" {{ old('bank') == 'BRI' ? 'selected' : '' }}>Bank Rakyat Indonesia (BRI)</option>
                                <option value="Mandiri" {{ old('bank') == 'Mandiri' ? 'selected' : '' }}>Bank Mandiri</option>
                                <option value="BSI" {{ old('bank') == 'BSI' ? 'selected' : '' }}>Bank Syariah Indonesia (BSI)</option>
                                <option value="CIMB" {{ old('bank') == 'CIMB' ? 'selected' : '' }}>CIMB Niaga</option>
                                <option value="Permata" {{ old('bank') == 'Permata' ? 'selected' : '' }}>Bank Permata</option>
                                <option value="BTN" {{ old('bank') == 'BTN' ? 'selected' : '' }}>Bank Tabungan Negara (BTN)</option>
                            </select>
                            @error('bank')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
