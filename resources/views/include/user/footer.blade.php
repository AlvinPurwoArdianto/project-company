<footer class="footer-section overflow-hidden position-relative footer-style2 p1-bg" id="contact">
                    ...
                    <div class="single-footer-widget">
                        <div class="widget-heads">
                            <a href="index.html" class="footer-logo">
                                <img src="{{ asset('user/assets/img/logo/logo-light.png') }}" alt="logo-img">
                            </a>
                        </div>
    ...
    <!-- Element -->
    <img src="{{ asset('user/assets/img/footer/f-apple.png') }}" alt="img" class="footer-apple position-absolute">
    <img src="{{ asset('user/assets/img/footer/f-cut.png') }}" alt="img" class="footer-cut position-absolute">
    <!-- Element -->
</footer>
